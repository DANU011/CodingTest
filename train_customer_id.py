...
from model_gating import BiLSTM_CNN_Attention
...
def train_model(config, time_series_df, meta_df, save_suffix):
    ...
    optimizer = optim.Adam(model.parameters(), lr=config['lr'], betas=(0.85, 0.999), eps=1e-7)
    ...
    for epoch in range(config['epochs']):
        ...
        if auc > best_auc:
            ...
            test_customer_ids = []
            shap_x_seq_test, shap_x_meta_test, shap_y_test = [], [], []
    ...
    return {
        ...
        'shap_input_test_path': shap_test_path
    }
