...
# ──────────────────────────────────────
# 2. 데이터 로드
data = np.load("shap_input_test_201807_201812_20250608_012201.npz")
...
model.load_state_dict(torch.load("best_churn_model_201807_201812_20250608_012201.pth", map_location="cpu"))
model.eval()
...
# plt.savefig("shap_summary_seq_all_weight.png", bbox_inches="tight", dpi=300)
# plt.close()
# print("Saved: shap_summary_seq_all_weight.png")
...
# 자동 x축 제한: 중앙 90% 분위수 사용
q_low, q_high = np.percentile(shap_seq_vals, [10, 90])
plt.xlim(q_low, q_high)

plt.title("SHAP – 전체 시계열 피처")
plt.savefig("shap_summary_seq_all_l1_v2.png", bbox_inches="tight", dpi=300)
plt.close()
print("Saved: shap_summary_seq_all_L1_v2.png")
...
# plt.savefig("shap_summary_meta_all_weight.png", bbox_inches="tight", dpi=300)
# plt.close()
# print("Saved: shap_summary_meta_all_weight.png")
...
q_low, q_high = np.percentile(shap_meta_vals, [5, 95])
plt.xlim(q_low, q_high)

plt.title("SHAP – 전체 메타 피처")
plt.savefig("shap_summary_meta_l1_v2.png", bbox_inches="tight", dpi=300)
plt.close()
print("Saved: shap_summary_meta_l1_v2.png")
